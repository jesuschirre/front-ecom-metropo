    ...
    <>
      <div className="min-h-screen bg-gradient-to-br py-7 px-4 sm:px-6 lg:px-8">
          ...
          <div className="font-[Sora] max-w-7xl mx-auto bg-[#232323] rounded-2xl mb-10 lg:p-7">
                <h1 className="font-bold text-xl mb-6">Edita tu avatar</h1>
                ...
                <div className="flex gap-6">
                  <div className="w-32 h-32 bg-gray-200 rounded-full flex items-center justify-center mb-4 border-4 border-gray-300">
                    <span className="text-gray-500 text-sm select-none">Sin imagen</span>
                  </div>
                  <div className="p-6  ">
                    <h1 className="text-xl font-bold text-white mb-4">Agrega un nuevo avatar</h1>
                    <button
                      className=" flex items-center bg-amber-400 font-semibold px-4 py-2 rounded-md hover:bg-amber-500 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-amber-400"
                      type="button"
                    >
          ...
          <div className="font-[Sora] max-w-7xl mx-auto space-y-12">
           <div className="bg-[#232323] text-white rounded-3xl shadow-2xl p-8 lg:p-10">
              ...
              <div className="lg:col-span-2">
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="mt-3 relative rounded-md shadow-sm">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><FaUserCircle className="h-5 w-5 text-gray-400" /></div>
                      <input type="text" defaultValue="Chirre Ynocente" className="block w-full pl-10 pr-3 py-2 bg-[#161616] text-[#8A8AA0] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition duration-200" />
                    </div>
                  </div>
                  <div className="md:col-span-2">
                    ...
                    <div className="mt-3 relative rounded-md shadow-sm">
                      ...
                      <input id="correo" type="email" name="correo" value={usuario.correo} onChange={handleChange} placeholder="Correo Electrónico" className="block w-full pl-10 pr-3 py-2 bg-[#161616] text-[#8A8AA0] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition duration-200" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-3 relative rounded-md shadow-sm">
                      ...
                      <input id="rol" type="text" name="rol" value={usuario.rol} disabled className="block w-full pl-10 pr-3 py-2  rounded-xl border-gray-300 bg-[#161616] cursor-not-allowed" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-3 relative rounded-md shadow-sm">
                      ...
                      <input type="text" defaultValue="+51 928337352" className="block w-full pl-10 pr-3 py-2 bg-[#161616] text-[#8A8AA0] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition duration-200" />
                    </div>
                  </div>
                  <div className="md:col-span-2">
          ...
          {usuario.rol === "vendedor" && vendedorInfo && (
            <div className="bg-[#232323] rounded-3xl shadow-2xl p-8 lg:p-10 text-white">
              ...
              <form onSubmit={handleSubmitVendedor} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-semibold mb-1">Nombre de la Tienda</label>
                  <div className="mt-3 relative rounded-md shadow-sm">
                    ...
                    <input id="nombre_tienda" type="text" name="nombre_tienda" value={vendedorInfo.nombre_tienda} onChange={(e) => setVendedorInfo({ ...vendedorInfo, nombre_tienda: e.target.value })} placeholder="Nombre de la tienda" className="block w-full pl-10 pr-3 py-2 bg-[#161616] text-[#8A8AA0] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition duration-200" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-semibold mb-1">Teléfono de la Tienda</label>
                  <div className="mt-3 relative rounded-md shadow-sm">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><FaPhone className="h-5 w-5 text-gray-400" /></div>
                    <input id="telefono" type="text" name="telefono" value={vendedorInfo.telefono} onChange={(e) => setVendedorInfo({ ...vendedorInfo, telefono: e.target.value })} placeholder="Teléfono" className="block w-full pl-10 pr-3 py-2 bg-[#161616] text-[#8A8AA0] rounded-xl border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition duration-200" />
                  </div>
                </div>
