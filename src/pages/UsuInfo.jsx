              ...
              <div className="lg:col-span-2">
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"><FaTag className="h-5 w-5 text-gray-400" /></div>
                  ...
                  <div>
                    ...
                    <div className="flex gap-4 mt-2">
                      <label className="flex items-center gap-1 text-gray-600"><input type="radio" name="genero" defaultChecked className="form-radio text-blue-600" /> Masculino</label>
                      <label className="flex items-center gap-1 text-gray-600"><input type="radio" name="genero" className="form-radio text-blue-600" /> Femenino</label>
                      <label className="flex items-center gap-1 text-gray-600"><input type="radio" name="genero" className="form-radio text-blue-600" /> Otro</label>
                    </div>
                  </div>
                  <div>
